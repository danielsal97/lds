...
- **Core Framework**: See [`/utilities`](../utilities/README.md) for framework components
- **Plugins**: See [`/plugins`](../plugins/README.md) for plugin implementation examples
- **Design Patterns**: See [`/design_patterns`](../design_patterns/README.md) for pattern usage
